  ...
  return (
    <html lang="pt-BR">
      <body className="min-h-screen bg-clinical-paper text-clinical-ink antialiased selection:bg-clinical-ink selection:text-clinical-paper">
        <HeaderNavigation />
        <main className="w-full max-w-5xl mx-auto p-3 sm:p-4 md:p-6 pb-28 sm:pb-32">
          {children}
        </main>
        <footer className="w-full border-t border-clinical-surface/40 bg-clinical-action text-white p-4 sm:p-6 mb-20 sm:mb-16 no-print text-xs sm:text-sm">
